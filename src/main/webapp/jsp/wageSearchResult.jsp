	...
	<div class="container-fluid"><!--容器-->
		<div class="row">
	  	...
	  	<div class="col-xs-8 col-md-10">
		  	...
		  	<div class="panel panel-default">
			  <div class="panel-heading">
			    <h3 class="panel-title" style="font-size: 30px;font-family: '楷体'; color:black">工资结算页面</h3>
			  </div>
			  <div class="panel-body">
			    <form class="form-horizontal" name="addDeptForm" method="post" action="wageSettlement.jsp">
				  ...
				  <div class="form-group">
				    <div class="col-sm-2"></div>
				     <div class="col-sm-4">
				      <button type="submit" class="btn btn-default">结算</button>
				     </div>
				  </div>
				</form>
			  </div>
			  ...
			  <div class="panel-body">
			    <form class="form-horizontal" name="addDeptForm" method="post">
				  ...
				  <div class="form-group">
				    <div class="col-sm-2"></div>
				     <div class="col-sm-4">
				      <a href="wageTemDeposit.jsp"><button type="button" class="btn btn-default">暂存</button></a>
				     </div>	
				    <div class="col-sm-2"></div>
				     <div class="col-sm-4">
				      <a href="wageGrantResult.jsp"><button type="button" class="btn btn-default">发放</button></a>
				     </div>
				  </div>
				</form>
			  </div>
