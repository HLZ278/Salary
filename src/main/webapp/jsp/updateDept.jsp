				...
				<div class="col-xs-8 col-md-10">
					...
					<form class="form-horizontal" role="form" method="post" name="salaryCalulation" action="#">
							...
							<div class="form-group">
								<label for="distributionOfMonth" class="col-sm-1 control-label">员工编号</label>
								<!--员工编号text-->
								...
								<label for="distributionOfMonth" class="col-sm-2 control-label">员工姓名</label>
								<!--员工姓名text-->
