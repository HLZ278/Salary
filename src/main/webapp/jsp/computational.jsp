	...
	<div class="row">
	  	...
	  	<form class="form-horizontal" role="form">
			  ...
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">第一个操作数*</label>
			    <div class="col-sm-4">
			     	<select class="form-control" name="Type" id="Type">
									  <option>请选择...</option>
									  <option>基本工资</option>
									  <option>个人养老保险</option>
						</select>
			    </div>
			  </div>
			  
			  <div class="form-group">
			    <label for="inputPassword3" class="col-sm-2 control-label">操作符*</label>
			    <div class="col-sm-4">
			     	<select class="form-control" name="Type" id="Type">
									  <option>请选择...</option>
									  <option>+</option>
				...
				<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label">第二个操作数*</label>
			    <div class="col-sm-4">
			      <input type="number" class="form-control" id="inputEmail3" placeholder="请输入数字">
			    </div>
			  </div>
